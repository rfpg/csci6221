goog.provide("module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development");
goog.provide("module$react_dom$cjs$react_dom_development");
goog.require("module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react$index");
goog.require("module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index");
var module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development = {"default":{}};
if (process.env.NODE_ENV !== "production") {
  (function() {
    if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ !== "undefined" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart === "function") {
      __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error);
    }
    var React = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react$index["default"];
    var Scheduler = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"];
    var ReactSharedInternals = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react$index["default"].__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    ...
    "horiz-origin-x", "image-rendering", "letter-spacing", "lighting-color", "marker-end", "marker-mid", "marker-start", "overline-position", "overline-thickness", "paint-order", "panose-1", "pointer-events", "rendering-intent", "shape-rendering", "stop-color", "stop-opacity", "strikethrough-position", "strikethrough-thickness", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "text-anchor", "text-decoration", "text-rendering", 
    "underline-position", "underline-thickness", "unicode-bidi", "unicode-range", "units-per-em", "v-alphabetic", "v-hanging", "v-ideographic", "v-mathematical", "vector-effect", "vert-adv-y", "vert-origin-x", "vert-origin-y", "word-spacing", "writing-mode", "xmlns:xlink", "x-height"].forEach(function(attributeName) {
    ...
    function describeBuiltInComponentFrame(name, source, ownerFn) {
      {
        if (prefix === undefined) {
          try {
            ...
            var match = x$40.stack.trim().match(/\n( *(at )?)/);
              ...
              if (s !== 1 || c !== 1) {
                do {
                  ...
                  if (c < 0 || sampleLines[s] !== controlLines[c]) {
                    ...
                    if (fn.displayName && _frame.includes("\x3canonymous\x3e")) {
                      _frame = _frame.replace("\x3canonymous\x3e", fn.displayName);
                    }
                    {
    ...
    function getStackByFiberInDevAndProd(workInProgress) {
      try {
        ...
        return "\nError generating stack: " + x$45.message + "\n" + x$45.stack;
      }
    }
    ...
    function getHostProps(element, props) {
      ...
      var hostProps = assign({}, props, {defaultChecked:undefined, defaultValue:undefined, value:undefined, checked:checked != null ? checked : node._wrapperState.initialChecked});
      return hostProps;
    }
    ...
    function validateProps(element, props) {
      {
        if (props.value == null) {
          if (typeof props.children === "object" && props.children !== null) {
            module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react$index["default"].Children.forEach(props.children, function(child) {
              if (child == null) {
                return;
              }
              ...
              if (!didWarnInvalidChild) {
                ...
                error("Cannot infer the option value of complex children. " + "Pass a `value` prop or use a plain string as children to \x3coption\x3e.");
              }
            });
          } else {
        ...
        if (props.selected != null && !didWarnSelectedSetOnOption) {
          error("Use the `defaultValue` or `value` props on \x3cselect\x3e instead of " + "setting `selected` on \x3coption\x3e.");
    ...
    function checkSelectPropTypes(props) {
      {
        ...
        for (var i = 0; i < valuePropNames.length; i++) {
          ...
          if (props.multiple && !propNameIsArray) {
            error("The `%s` prop supplied to \x3cselect\x3e must be an array if " + "`multiple` is true.%s", propName, getDeclarationErrorAddendum());
          } else {
            if (!props.multiple && propNameIsArray) {
              error("The `%s` prop supplied to \x3cselect\x3e must be a scalar " + "value if `multiple` is false.%s", propName, getDeclarationErrorAddendum());
            }
          }
        }
      }
    ...
    function getHostProps$2(element, props) {
      var node = element;
      if (props.dangerouslySetInnerHTML != null) {
        throw new Error("`dangerouslySetInnerHTML` does not make sense on \x3ctextarea\x3e.");
      }
      var hostProps = assign({}, props, {value:undefined, defaultValue:undefined, children:toString(node._wrapperState.initialValue)});
      return hostProps;
    }
        ...
        if (children != null) {
          ...
          }
          {
            if (defaultValue != null) {
              throw new Error("If you supply `defaultValue` on a \x3ctextarea\x3e, do not pass children.");
            }
            if (isArray(children)) {
              if (children.length > 1) {
                throw new Error("\x3ctextarea\x3e can only have at most one child.");
              }
              children = children[0];
            }
    ...
    var shorthandToLonghand = {animation:["animationDelay", "animationDirection", "animationDuration", "animationFillMode", "animationIterationCount", "animationName", "animationPlayState", "animationTimingFunction"], background:["backgroundAttachment", "backgroundClip", "backgroundColor", "backgroundImage", "backgroundOrigin", "backgroundPositionX", "backgroundPositionY", "backgroundRepeat", "backgroundSize"], backgroundPosition:["backgroundPositionX", "backgroundPositionY"], border:["borderBottomColor", 
    "borderBottomStyle", "borderBottomWidth", "borderImageOutset", "borderImageRepeat", "borderImageSlice", "borderImageSource", "borderImageWidth", "borderLeftColor", "borderLeftStyle", "borderLeftWidth", "borderRightColor", "borderRightStyle", "borderRightWidth", "borderTopColor", "borderTopStyle", "borderTopWidth"], borderBlockEnd:["borderBlockEndColor", "borderBlockEndStyle", "borderBlockEndWidth"], borderBlockStart:["borderBlockStartColor", "borderBlockStartStyle", "borderBlockStartWidth"], 
    ...
    "columnRuleStyle", "columnRuleWidth"], columns:["columnCount", "columnWidth"], flex:["flexBasis", "flexGrow", "flexShrink"], flexFlow:["flexDirection", "flexWrap"], font:["fontFamily", "fontFeatureSettings", "fontKerning", "fontLanguageOverride", "fontSize", "fontSizeAdjust", "fontStretch", "fontStyle", "fontVariant", "fontVariantAlternates", "fontVariantCaps", "fontVariantEastAsian", "fontVariantLigatures", "fontVariantNumeric", "fontVariantPosition", "fontWeight", "lineHeight"], fontVariant:["fontVariantAlternates", 
    "fontVariantCaps", "fontVariantEastAsian", "fontVariantLigatures", "fontVariantNumeric", "fontVariantPosition"], gap:["columnGap", "rowGap"], grid:["gridAutoColumns", "gridAutoFlow", "gridAutoRows", "gridTemplateAreas", "gridTemplateColumns", "gridTemplateRows"], gridArea:["gridColumnEnd", "gridColumnStart", "gridRowEnd", "gridRowStart"], gridColumn:["gridColumnEnd", "gridColumnStart"], gridColumnGap:["columnGap"], gridGap:["columnGap", "rowGap"], gridRow:["gridRowEnd", "gridRowStart"], gridRowGap:["rowGap"], 
    gridTemplate:["gridTemplateAreas", "gridTemplateColumns", "gridTemplateRows"], listStyle:["listStyleImage", "listStylePosition", "listStyleType"], margin:["marginBottom", "marginLeft", "marginRight", "marginTop"], marker:["markerEnd", "markerMid", "markerStart"], mask:["maskClip", "maskComposite", "maskImage", "maskMode", "maskOrigin", "maskPositionX", "maskPositionY", "maskRepeat", "maskSize"], maskPosition:["maskPositionX", "maskPositionY"], outline:["outlineColor", "outlineStyle", "outlineWidth"], 
    overflow:["overflowX", "overflowY"], padding:["paddingBottom", "paddingLeft", "paddingRight", "paddingTop"], placeContent:["alignContent", "justifyContent"], placeItems:["alignItems", "justifyItems"], placeSelf:["alignSelf", "justifySelf"], textDecoration:["textDecorationColor", "textDecorationLine", "textDecorationStyle"], textEmphasis:["textEmphasisColor", "textEmphasisStyle"], transition:["transitionDelay", "transitionDuration", "transitionProperty", "transitionTimingFunction"], wordWrap:["overflowWrap"]};
    var isUnitlessNumber = {animationIterationCount:true, aspectRatio:true, borderImageOutset:true, borderImageSlice:true, borderImageWidth:true, boxFlex:true, boxFlexGroup:true, boxOrdinalGroup:true, columnCount:true, columns:true, flex:true, flexGrow:true, flexPositive:true, flexShrink:true, flexNegative:true, flexOrder:true, gridArea:true, gridRow:true, gridRowEnd:true, gridRowSpan:true, gridRowStart:true, gridColumn:true, gridColumnEnd:true, gridColumnSpan:true, gridColumnStart:true, fontWeight:true, 
    lineClamp:true, lineHeight:true, opacity:true, order:true, orphans:true, tabSize:true, widows:true, zIndex:true, zoom:true, fillOpacity:true, floodOpacity:true, stopOpacity:true, strokeDasharray:true, strokeDashoffset:true, strokeMiterlimit:true, strokeOpacity:true, strokeWidth:true};
    ...
    function assertValidProps(tag, props) {
      ...
      if (props.style != null && typeof props.style !== "object") {
        throw new Error("The `style` prop expects a mapping from style properties to values, " + "not a string. For example, style\x3d{{marginRight: spacing + 'em'}} when " + "using JSX.");
      }
    }
    ...
    y1:"y1", y2:"y2", y:"y", ychannelselector:"yChannelSelector", z:"z", zoomandpan:"zoomAndPan"};
    ...
    function warnInvalidARIAProps(type, props) {
      {
        ...
        if (invalidProps.length === 1) {
          error("Invalid aria prop %s on \x3c%s\x3e tag. " + "For details, see https://reactjs.org/link/invalid-aria-props", unknownPropString, type);
        } else {
          if (invalidProps.length > 1) {
            error("Invalid aria props %s on \x3c%s\x3e tag. " + "For details, see https://reactjs.org/link/invalid-aria-props", unknownPropString, type);
          }
        }
      }
    }
    ...
    };
    {
      ...
      validateProperty$1 = function(tagName, name, value, eventRegistry) {
        ...
        if (possibleStandardNames.hasOwnProperty(lowerCasedName)) {
          ...
          if (!isReserved && name !== lowerCasedName) {
        ...
        if (typeof value === "boolean" && shouldRemoveAttributeWithWarning(name, value, propertyInfo, false)) {
          if (value) {
            error("Received `%s` for a non-boolean attribute `%s`.\n\n" + "If you want to write it to the DOM, pass a string instead: " + '%s\x3d"%s" or %s\x3d{value.toString()}.', value, name, name, value, name);
          } else {
            error("Received `%s` for a non-boolean attribute `%s`.\n\n" + "If you want to write it to the DOM, pass a string instead: " + '%s\x3d"%s" or %s\x3d{value.toString()}.\n\n' + "If you used to conditionally omit it with %s\x3d{condition \x26\x26 value}, " + "pass %s\x3d{condition ? value : undefined} instead.", value, name, name, value, name, name, name);
          }
          warnedProperties$1[name] = true;
          return true;
        }
        ...
        if ((value === "false" || value === "true") && propertyInfo !== null && propertyInfo.type === BOOLEAN) {
          error("Received the string `%s` for the boolean attribute `%s`. " + "%s " + "Did you mean %s\x3d{%s}?", value, name, value === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', name, value);
          warnedProperties$1[name] = true;
          return true;
        }
        return true;
    ...
    var warnUnknownProperties = function(type, props, eventRegistry) {
      {
        ...
        if (unknownProps.length === 1) {
          error("Invalid value for prop %s on \x3c%s\x3e tag. Either remove it from the element, " + "or pass a string or number value to keep it in the DOM. " + "For details, see https://reactjs.org/link/attribute-behavior ", unknownPropString, type);
        } else {
          if (unknownProps.length > 1) {
            error("Invalid values for props %s on \x3c%s\x3e tag. Either remove them from the element, " + "or pass a string or number value to keep them in the DOM. " + "For details, see https://reactjs.org/link/attribute-behavior ", unknownPropString, type);
          }
        }
      }
    };
    ...
    var scheduleCallback = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_scheduleCallback;
    var cancelCallback = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_cancelCallback;
    var shouldYield = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_shouldYield;
    var requestPaint = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_requestPaint;
    var now = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_now;
    var getCurrentPriorityLevel = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_getCurrentPriorityLevel;
    var ImmediatePriority = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_ImmediatePriority;
    var UserBlockingPriority = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_UserBlockingPriority;
    var NormalPriority = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_NormalPriority;
    var LowPriority = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_LowPriority;
    var IdlePriority = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_IdlePriority;
    var unstable_yieldValue = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_yieldValue;
    var unstable_setDisableYieldValue = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_setDisableYieldValue;
    var rendererID = null;
    ...
    function injectInternals(internals) {
      ...
      try {
        if (enableSchedulingProfiler) {
          internals = assign({}, internals, {getLaneLabelMap:getLaneLabelMap, injectProfilingHooks:injectProfilingHooks});
        }
    ...
    function createQueuedReplayableEvent(blockedOn, domEventName, eventSystemFlags, targetContainer, nativeEvent) {
      return {blockedOn:blockedOn, domEventName:domEventName, eventSystemFlags:eventSystemFlags, nativeEvent:nativeEvent, targetContainers:[targetContainer]};
    }
    ...
    function scheduleCallbackIfUnblocked(queuedEvent, unblocked) {
      if (queuedEvent.blockedOn === unblocked) {
        ...
        if (!hasScheduledReplayAttempt) {
          ...
          module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_scheduleCallback(module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_NormalPriority, replayUnblockedEvents);
        }
      }
    }
    ...
    function addEventCaptureListenerWithPassiveFlag(target, eventType, listener, passive) {
      target.addEventListener(eventType, listener, {capture:true, passive:passive});
      return listener;
    }
    ...
    function createSyntheticEvent(Interface) {
      ...
      assign(SyntheticBaseEvent.prototype, {preventDefault:function() {
        ...
        if (event.preventDefault) {
          ...
          if (typeof event.returnValue !== "unknown") {
    ...
    var KeyboardEventInterface = assign({}, UIEventInterface, {key:getEventKey, code:0, location:0, ctrlKey:0, shiftKey:0, altKey:0, metaKey:0, repeat:0, locale:0, getModifierState:getEventModifierState, charCode:function(event) {
    ...
    var WheelEventInterface = assign({}, MouseEventInterface, {deltaX:function(event) {
    ...
    function extractCompositionEvent(dispatchQueue, domEventName, targetInst, nativeEvent, nativeEventTarget) {
      ...
      if (canUseCompositionEvent) {
        ...
        if (!isComposing) {
          ...
          if (isFallbackCompositionEnd(domEventName, nativeEvent)) {
    ...
    function getSelectionInformation() {
      ...
      return {focusedElem:focusedElem, selectionRange:hasSelectionCapabilities(focusedElem) ? getSelection(focusedElem) : null};
    }
    ...
    "paste", "pause", "play", "playing", "pointerCancel", "pointerDown", "pointerMove", "pointerOut", "pointerOver", "pointerUp", "progress", "rateChange", "reset", "resize", "seeked", "seeking", "stalled", "submit", "suspend", "timeUpdate", "touchCancel", "touchEnd", "touchStart", "volumeChange", "scroll", "toggle", "touchMove", "waiting", "wheel"];
    ...
    function processDispatchQueueItemsInOrder(event, dispatchListeners, inCapturePhase) {
      ...
      if (inCapturePhase) {
        ...
        for (var _i = 0; _i < dispatchListeners.length; _i++) {
          ...
          var _instance = _dispatchListeners$_i.instance;
          var _currentTarget = _dispatchListeners$_i.currentTarget;
          var _listener = _dispatchListeners$_i.listener;
    ...
    function processDispatchQueue(dispatchQueue, eventSystemFlags) {
      ...
      for (var i = 0; i < dispatchQueue.length; i++) {
        ...
        var event = _dispatchQueue$i.event;
        var listeners = _dispatchQueue$i.listeners;
    ...
    function createDispatchListener(instance, listener, currentTarget) {
      return {instance:instance, listener:listener, currentTarget:currentTarget};
    }
    function accumulateSinglePhaseListeners(targetFiber, reactName, nativeEventType, inCapturePhase, accumulateTargetOnly, nativeEvent) {
      ...
      while (instance !== null) {
        ...
        var stateNode = _instance2.stateNode;
        var tag = _instance2.tag;
    ...
    function accumulateTwoPhaseListeners(targetFiber, reactName) {
      ...
      while (instance !== null) {
        ...
        var stateNode = _instance3.stateNode;
        var tag = _instance3.tag;
        if (tag === HostComponent && stateNode !== null) {
    ...
    function accumulateEnterLeaveListenersForEvent(dispatchQueue, event, target, common, inCapturePhase) {
      ...
      while (instance !== null) {
        ...
        var alternate = _instance4.alternate;
        var stateNode = _instance4.stateNode;
        var tag = _instance4.tag;
    ...
    var normalizeHTML;
    {
      ...
      validatePropertiesInDevelopment = function(type, props) {
        ...
        validateProperties$2(type, props, {registrationNameDependencies:registrationNameDependencies, possibleRegistrationNames:possibleRegistrationNames});
      };
        ...
        if (propKey === STYLE) {
          ...
          if (propKey === DANGEROUSLY_SET_INNER_HTML) {
            ...
            if (propKey === CHILDREN) {
              ...
              if (propKey === SUPPRESS_CONTENT_EDITABLE_WARNING || propKey === SUPPRESS_HYDRATION_WARNING) {
              } else {
                if (propKey === AUTOFOCUS) {
                } else {
      ...
      if (namespaceURI === HTML_NAMESPACE) {
        {
          ...
          if (!isCustomComponentTag && type !== type.toLowerCase()) {
            error("\x3c%s /\x3e is using incorrect casing. " + "Use PascalCase for React components, " + "or lowercase for HTML elements.", type);
          }
        }
        if (type === "script") {
      ...
      }
      {
        if (namespaceURI === HTML_NAMESPACE) {
          if (!isCustomComponentTag && Object.prototype.toString.call(domElement) === "[object HTMLUnknownElement]" && !hasOwnProperty.call(warnedUnknownTags, type)) {
            ...
            error("The tag \x3c%s\x3e is unrecognized in this browser. " + "If you meant to render a React component, start its name with " + "an uppercase letter.", type);
          }
        }
      }
      return domElement;
      ...
      for (var propKey in rawProps) {
        ...
        if (propKey === CHILDREN) {
          ...
          if (registrationNameDependencies.hasOwnProperty(propKey)) {
            ...
            if (shouldWarnDev && true && typeof isCustomComponentTag === "boolean") {
                ...
                if (propKey === SUPPRESS_CONTENT_EDITABLE_WARNING || propKey === SUPPRESS_HYDRATION_WARNING || propKey === "value" || propKey === "checked" || propKey === "selected") {
                  ...
                  if (propKey === DANGEROUSLY_SET_INNER_HTML) {
                    ...
                    if (propKey === STYLE) {
                      ...
                      if (isCustomComponentTag && !enableCustomElementPropertySupport) {
                        ...
                        if (!shouldIgnoreAttribute(propKey, propertyInfo, isCustomComponentTag) && !shouldRemoveAttribute(propKey, nextProp, propertyInfo, isCustomComponentTag)) {
    ...
    function warnForDeletedHydratableElement(parentNode, child) {
      {
        ...
        didWarnInvalidHydration = true;
        error("Did not expect server HTML to contain a \x3c%s\x3e in \x3c%s\x3e.", child.nodeName.toLowerCase(), parentNode.nodeName.toLowerCase());
      }
    }
    function warnForDeletedHydratableText(parentNode, child) {
      {
        ...
        didWarnInvalidHydration = true;
        error('Did not expect server HTML to contain the text node "%s" in \x3c%s\x3e.', child.nodeValue, parentNode.nodeName.toLowerCase());
      }
    }
    function warnForInsertedHydratedElement(parentNode, tag, props) {
      {
        ...
        didWarnInvalidHydration = true;
        error("Expected server HTML to contain a matching \x3c%s\x3e in \x3c%s\x3e.", tag, parentNode.nodeName.toLowerCase());
      }
    }
    function warnForInsertedHydratedText(parentNode, text) {
      {
        ...
        didWarnInvalidHydration = true;
        error('Expected server HTML to contain a matching text node for "%s" in \x3c%s\x3e.', text, parentNode.nodeName.toLowerCase());
      }
    }
    ...
    {
      var specialTags = ["address", "applet", "area", "article", "aside", "base", "basefont", "bgsound", "blockquote", "body", "br", "button", "caption", "center", "col", "colgroup", "dd", "details", "dir", "div", "dl", "dt", "embed", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "iframe", "img", "input", "isindex", "li", "link", "listing", "main", "marquee", "menu", "menuitem", "meta", "nav", 
      "noembed", "noframes", "noscript", "object", "ol", "p", "param", "plaintext", "pre", "script", "section", "select", "source", "style", "summary", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "title", "tr", "track", "ul", "wbr", "xmp"];
      ...
      validateDOMNesting = function(childTag, childText, ancestorInfo) {
        ...
        if (childTag === "#text") {
          ...
          tagDisplayName = "\x3c" + childTag + "\x3e";
        }
        if (invalidParent) {
          var info = "";
          if (ancestorTag === "table" && childTag === "tr") {
            info += " Add a \x3ctbody\x3e, \x3cthead\x3e or \x3ctfoot\x3e to your code to match the DOM tree generated by " + "the browser.";
          }
          error("validateDOMNesting(...): %s cannot appear as a child of \x3c%s\x3e.%s%s", tagDisplayName, ancestorTag, whitespaceInfo, info);
        } else {
          error("validateDOMNesting(...): %s cannot appear as a descendant of " + "\x3c%s\x3e.", tagDisplayName, ancestorTag);
        }
      };
    }
      ...
      do {
        ...
        if (nextNode && nextNode.nodeType === COMMENT_NODE) {
          ...
          if (data === SUSPENSE_END_DATA) {
            ...
            if (data === SUSPENSE_START_DATA || data === SUSPENSE_PENDING_START_DATA || data === SUSPENSE_FALLBACK_START_DATA) {
              depth++;
            }
          }
        }
    ...
    function errorHydratingContainer(parentContainer) {
      {
        error("An error occurred during hydration. The server HTML was replaced with client content in \x3c%s\x3e.", parentContainer.nodeName.toLowerCase());
      }
    }
    ...
    function warnOnFunctionType(returnFiber) {
      {
        ...
        error("Functions are not valid as a React child. This may happen if " + "you return a Component instead of \x3cComponent /\x3e from render. " + "Or maybe you meant to call this function rather than return it.");
      }
    }
    ...
    function scheduleContextWorkOnParentPath(parent, renderLanes, propagationRoot) {
      ...
      while (node !== null) {
        ...
        if (!isSubsetOfLanes(node.childLanes, renderLanes)) {
          ...
          if (alternate !== null && !isSubsetOfLanes(alternate.childLanes, renderLanes)) {
            alternate.childLanes = mergeLanes(alternate.childLanes, renderLanes);
          }
        }
      ...
      while (fiber !== null) {
        ...
        if (list !== null) {
          ...
          if (fiber.tag === ContextProvider) {
            ...
            if (fiber.tag === DehydratedFragment) {
    ...
    function readContext(context) {
      ...
      if (lastFullyObservedContext === context) {
        ...
        var contextItem = {context:context, memoizedValue:value, next:null};
    ...
    function createUpdate(eventTime, lane) {
      var update = {eventTime:eventTime, lane:lane, tag:UpdateState, payload:null, callback:null, next:null};
      return update;
    }
      ...
      if (firstBaseUpdate !== null) {
        ...
        do {
          ...
          if (!isSubsetOfLanes(renderLanes, updateLane)) {
            ...
            if (newLastBaseUpdate !== null) {
              var _clone = {eventTime:updateEventTime, lane:NoLane, tag:update.tag, payload:update.payload, callback:update.callback, next:null};
    ...
    function findFirstSuspended(row) {
      ...
      while (node !== null) {
        if (node.tag === SuspenseComponent) {
          ...
          if (node.tag === SuspenseListComponent && node.memoizedProps.revealOrder !== undefined) {
      ...
      if (baseQueue !== null) {
        ...
        do {
          ...
          if (!isSubsetOfLanes(renderLanes, updateLane)) {
            ...
            if (newBaseQueueLast !== null) {
              var _clone = {lane:NoLane, action:update.action, hasEagerState:update.hasEagerState, eagerState:update.eagerState, next:null};
    ...
    function pushStoreConsistencyCheck(fiber, getSnapshot, renderedSnapshot) {
      ...
      var check = {getSnapshot:getSnapshot, value:renderedSnapshot};
    ...
    function mountTransition() {
      ...
      var isPending = _mountState[0];
      var setPending = _mountState[1];
    ...
    function rerenderTransition() {
      ...
      var isPending = _rerenderState[0];
      var hook = updateWorkInProgressHook();
      var start = hook.memoizedState;
      return [isPending, start];
    }
    ...
    function dispatchReducerAction(fiber, queue, action) {
      ...
      var update = {lane:lane, action:action, hasEagerState:false, eagerState:null, next:null};
    ...
    var now$1 = module$Users$maryamkhanoom$csci6221$todo_list$node_modules$scheduler$index["default"].unstable_now;
    var commitTime = 0;
    ...
    var classComponentUpdater = {isMounted:isMounted, enqueueSetState:function(inst, payload, callback) {
      var fiber = get(inst);
      var eventTime = requestEventTime();
      var lane = requestUpdateLane(fiber);
          ...
          if (!isValid && !didWarnAboutInvalidateContextType.has(ctor)) {
            ...
            if (contextType === undefined) {
              ...
              if (typeof contextType !== "object") {
                ...
                if (contextType.$$typeof === REACT_PROVIDER_TYPE) {
                  addendum = " Did you accidentally pass the Context.Provider instead?";
                } else {
                  if (contextType._context !== undefined) {
    ...
    function createCapturedValueAtFiber(value, source) {
      return {value:value, source:source, stack:getStackByFiberInDevAndProd(source), digest:null};
    }
    function createCapturedValue(value, digest, stack) {
      return {value:value, source:null, stack:stack != null ? stack : null, digest:digest != null ? digest : null};
    }
    ...
    function logCapturedError(boundary, errorInfo) {
      try {
        ...
        if (true) {
          ...
          var componentNameMessage = componentName ? "The above error occurred in the \x3c" + componentName + "\x3e component:" : "The above error occurred in one of your React components:";
      ...
      }
      {
        if (Component.prototype && typeof Component.prototype.render === "function") {
          ...
          if (!didWarnAboutBadClass[componentName]) {
            error("The \x3c%s /\x3e component appears to have a render method, but doesn't extend React.Component. " + "This is likely to cause errors. Change %s to extend React.Component instead.", componentName, componentName);
    ...
    function mountSuspenseOffscreenState(renderLanes) {
      return {baseLanes:renderLanes, cachePool:getSuspendedCache(), transitions:null};
    }
    function updateSuspenseOffscreenState(prevOffscreenState, renderLanes) {
      var cachePool = null;
      return {baseLanes:mergeLanes(prevOffscreenState.baseLanes, renderLanes), cachePool:cachePool, transitions:prevOffscreenState.transitions};
    }
    ...
    function mountDehydratedSuspenseComponent(workInProgress, suspenseInstance, renderLanes) {
      if ((workInProgress.mode & ConcurrentMode) === NoMode) {
        {
          error("Cannot hydrate Suspense in legacy mode. Switch from " + "ReactDOM.hydrate(element, container) to " + "ReactDOMClient.hydrateRoot(container, \x3cApp /\x3e)" + ".render(element) or remove the Suspense components from " + "the server rendered components.");
        }
    ...
    function propagateSuspenseContextChange(workInProgress, firstChild, renderLanes) {
      ...
      while (node !== null) {
        if (node.tag === SuspenseComponent) {
          ...
          if (node.tag === SuspenseListComponent) {
            scheduleSuspenseWorkOnFiber(node, renderLanes, workInProgress);
          } else {
            if (node.child !== null) {
              node.child["return"] = node;
        ...
        if (tailMode !== undefined && !didWarnAboutTailOptions[tailMode]) {
          if (tailMode !== "collapsed" && tailMode !== "hidden") {
            ...
            if (revealOrder !== "forwards" && revealOrder !== "backwards") {
              didWarnAboutTailOptions[tailMode] = true;
              error('\x3cSuspenseList tail\x3d"%s" /\x3e is only valid if revealOrder is ' + '"forwards" or "backwards". ' + 'Did you mean to specify revealOrder\x3d"forwards"?', tailMode);
            }
          }
        }
      }
    ...
    function validateSuspenseListNestedChild(childSlot, index) {
      {
        ...
        if (isAnArray || isIterable) {
          ...
          error("A nested %s was passed to row #%s in \x3cSuspenseList /\x3e. Wrap it in " + "an additional SuspenseList to configure its revealOrder: " + "\x3cSuspenseList revealOrder\x3d...\x3e ... " + "\x3cSuspenseList revealOrder\x3d...\x3e{%s}\x3c/SuspenseList\x3e ... " + "\x3c/SuspenseList\x3e", type, index, type);
          return false;
        }
      }
      return true;
    ...
    function initSuspenseListRenderState(workInProgress, isBackwards, tail, lastContentRow, tailMode) {
      ...
      if (renderState === null) {
        workInProgress.memoizedState = {isBackwards:isBackwards, rendering:null, renderingStartTime:0, last:lastContentRow, tail:tail, tailMode:tailMode};
      } else {
      ...
      var newValue = newProps.value;
      {
        if (!("value" in newProps)) {
          if (!hasWarnedAboutUsingNoValuePropOnContextProvider) {
            ...
            error("The `value` prop is required for the `\x3cContext.Provider\x3e`. Did you misspell it or forget to pass it?");
          }
        }
        ...
        if (context._context === undefined) {
          if (context !== context.Consumer) {
            if (!hasWarnedAboutUsingContextAsConsumer) {
              ...
              error("Rendering \x3cContext\x3e directly is not supported and will be removed in " + "a future major release. Did you mean to render \x3cContext.Consumer\x3e instead?");
            }
          }
        } else {
            ...
            if (renderedTail === null) {
              ...
              if (!didSuspendAlready) {
                ...
                if (_suspended !== null) {
                  ...
                  if (now() * 2 - renderState.renderingStartTime > getRenderTargetTime() && renderLanes !== OffscreenLane) {
                    workInProgress.flags |= DidCapture;
                    didSuspendAlready = true;
                    cutOffTailIfNeeded(renderState, false);
                    workInProgress.lanes = SomeRetryLane;
    ...
    function safelyCallCommitHookLayoutEffectListMount(current, nearestMountedAncestor) {
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$54);
      }
    }
    function safelyCallComponentWillUnmount(current, nearestMountedAncestor, instance) {
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$55);
      }
    }
    function safelyCallComponentDidMount(current, nearestMountedAncestor, instance) {
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$56);
      }
    }
    function safelyAttachRef(current, nearestMountedAncestor) {
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$57);
      }
    }
      ...
      if (ref !== null) {
        if (typeof ref === "function") {
          ...
          try {
            ...
            captureCommitPhaseError(current, nearestMountedAncestor, error$58);
          }
          {
    ...
    function safelyCallDestroy(current, nearestMountedAncestor, destroy) {
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$59);
      }
    }
    ...
    function commitBeforeMutationEffects_complete() {
      while (nextEffect !== null) {
        ...
        try {
          ...
          captureCommitPhaseError(fiber, fiber["return"], error$60);
        }
        resetCurrentFiber();
            ...
            }
            {
              ...
              if (destroy !== undefined && typeof destroy !== "function") {
                ...
                if ((effect.tag & Layout) !== NoFlags) {
                  ...
                  if ((effect.tag & Insertion) !== NoFlags) {
            ...
            case Profiler:
              {
                ...
                var onPostCommit = _finishedWork$memoize.onPostCommit;
            ...
            {
              {
                ...
                var onCommit = _finishedWork$memoize2.onCommit;
          ...
          if (node.tag === HostComponent) {
            if (hostSubtreeRoot === null) {
              ...
              try {
                ...
                captureCommitPhaseError(finishedWork, finishedWork["return"], error$61);
              }
            }
          } else {
            if (node.tag === HostText) {
              if (hostSubtreeRoot === null) {
                try {
                  ...
                  captureCommitPhaseError(finishedWork, finishedWork["return"], error$62);
                }
              }
            } else {
              if ((node.tag === OffscreenComponent || node.tag === LegacyHiddenComponent) && node.memoizedState !== null && node !== finishedWork) {
              } else {
                if (node.child !== null) {
                  node.child["return"] = node;
                  node = node.child;
      ...
      if (deletions !== null) {
        for (var i = 0; i < deletions.length; i++) {
          ...
          try {
            ...
            captureCommitPhaseError(childToDelete, parentFiber, error$63);
          }
        }
      }
        ...
        case SimpleMemoComponent:
          {
            ...
            if (flags & Update) {
              try {
                ...
                captureCommitPhaseError(finishedWork, finishedWork["return"], error$64);
              }
              if (finishedWork.mode & ProfileMode) {
                try {
                  startLayoutEffectTimer();
                  ...
                  captureCommitPhaseError(finishedWork, finishedWork["return"], error$65);
                }
                recordLayoutEffectDuration(finishedWork);
              } else {
                try {
                  ...
                  captureCommitPhaseError(finishedWork, finishedWork["return"], error$66);
                }
              }
            }
            return;
            ...
            }
            {
              if (finishedWork.flags & ContentReset) {
                ...
                try {
                  ...
                  captureCommitPhaseError(finishedWork, finishedWork["return"], error$67);
                }
              }
              if (flags & Update) {
                ...
                if (_instance4 != null) {
                  ...
                  if (updatePayload !== null) {
                    try {
                      ...
                      captureCommitPhaseError(finishedWork, finishedWork["return"], error$68);
                    }
                  }
                }
              }
            ...
            if (flags & Update) {
              {
                ...
                try {
                  ...
                  captureCommitPhaseError(finishedWork, finishedWork["return"], error$69);
                }
              }
            }
            return;
              ...
              if (current !== null) {
                ...
                if (prevRootState.isDehydrated) {
                  try {
                    ...
                    captureCommitPhaseError(finishedWork, finishedWork["return"], error$70);
                  }
                }
              }
            }
        ...
        case SuspenseComponent:
          {
            ...
            if (flags & Update) {
              try {
                ...
                captureCommitPhaseError(finishedWork, finishedWork["return"], error$71);
              }
    ...
    function commitReconciliationEffects(finishedWork) {
      ...
      if (flags & Placement) {
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork["return"], error$72);
        }
      ...
      while (nextEffect !== null) {
        ...
        if ((fiber.flags & LayoutMask) !== NoFlags) {
          ...
          try {
            ...
            captureCommitPhaseError(fiber, fiber["return"], error$73);
          }
          resetCurrentFiber();
        }
    ...
    function reappearLayoutEffects_complete(subtreeRoot) {
      while (nextEffect !== null) {
        ...
        try {
          ...
          captureCommitPhaseError(fiber, fiber["return"], error$74);
        }
        resetCurrentFiber();
        if (fiber === subtreeRoot) {
          nextEffect = null;
      ...
      while (nextEffect !== null) {
        ...
        if ((fiber.flags & Passive) !== NoFlags) {
          ...
          try {
            ...
            captureCommitPhaseError(fiber, fiber["return"], error$75);
          }
          resetCurrentFiber();
        }
        if (fiber === subtreeRoot) {
          ...
          case SimpleMemoComponent:
            {
              try {
                ...
                captureCommitPhaseError(fiber, fiber["return"], error$76);
              }
              break;
            }
          case ClassComponent:
            {
              ...
              try {
                ...
                captureCommitPhaseError(fiber, fiber["return"], error$77);
              }
              break;
            }
        }
          ...
          case SimpleMemoComponent:
            {
              try {
                ...
                captureCommitPhaseError(fiber, fiber["return"], error$78);
              }
              break;
            }
        }
          ...
          case SimpleMemoComponent:
            {
              try {
                ...
                captureCommitPhaseError(fiber, fiber["return"], error$79);
              }
              break;
            }
          case ClassComponent:
          ...
          case SimpleMemoComponent:
            {
              try {
                ...
                captureCommitPhaseError(fiber, fiber["return"], error$80);
              }
            }
        }
      }
    ...
    function commitRootImpl(root, recoverableErrors, transitions, renderPriorityLevel) {
      ...
      if (recoverableErrors !== null) {
        ...
        for (var i = 0; i < recoverableErrors.length; i++) {
          ...
          onRecoverableError(recoverableError.value, {componentStack:componentStack, digest:digest});
        }
      }
      if (hasUncaughtError) {
          ...
          case FunctionComponent:
            {
              if (typeof nextType === "function") {
                ...
                if ($$typeofNextType === REACT_LAZY_TYPE) {
                  needsCompareFamilies = true;
                }
              }
              break;
    ...
    var scheduleRefresh = function(root, update) {
      {
        ...
        var updatedFamilies = update.updatedFamilies;
        flushPassiveEffects();
        flushSync(function() {
    ...
    function createFiberRoot(containerInfo, tag, hydrate, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
      ...
      {
        var _initialState = {element:initialChildren, isDehydrated:hydrate, cache:null, transitions:null, pendingSuspenseBoundaries:null};
    ...
    ReactDOMHydrationRoot.prototype.render = ReactDOMRoot.prototype.render = function(children) {
      ...
      }
      {
        if (typeof arguments[1] === "function") {
          ...
          if (isValidContainer(arguments[1])) {
    ...
    function createRoot(container, options) {
      ...
      if (options !== null && options !== undefined) {
        {
          if (options.hydrate) {
            warn("hydrate through createRoot is deprecated. Use ReactDOMClient.hydrateRoot(container, \x3cApp /\x3e) instead.");
          } else {
    ...
    function hydrateRoot(container, initialChildren, options) {
      ...
      warnIfReactDOMContainerInDEV(container);
      {
        if (initialChildren === undefined) {
          error("Must provide initial children as second argument to hydrateRoot. " + "Example usage: hydrateRoot(domContainer, \x3cApp /\x3e)");
        }
      }
    ...
    var Internals = {usingClientEntryPoint:false, Events:[getInstanceFromNode, getNodeFromInstance, getFiberCurrentPropsFromNode, enqueueStateRestore, restoreStateIfNeeded, batchedUpdates$1]};
    ...
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Internals;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].createPortal = createPortal$1;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].createRoot = createRoot$1;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].findDOMNode = findDOMNode;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].flushSync = flushSync$1;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].hydrate = hydrate;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].hydrateRoot = hydrateRoot$1;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].render = render;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].unmountComponentAtNode = unmountComponentAtNode;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].unstable_batchedUpdates = batchedUpdates$1;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].unstable_renderSubtreeIntoContainer = renderSubtreeIntoContainer;
    module$Users$maryamkhanoom$csci6221$todo_list$node_modules$react_dom$cjs$react_dom_development["default"].version = ReactVersion;
