...
var G__24323 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24323;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24324 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24324,ch);
...
if(("\\" === ch__$1)){
var ch_24325__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24325__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24325__$2);
} else {
}

var G__24326 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24326;
continue;
}
}
...
var vec__24334 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24334,(0),null);
var start_column = cljs.core.nth.call(null,vec__24334,(1),null);
...
var G__24337 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24337;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24338 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24339 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24339);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24338);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24340 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24340,(0),null);
var start_column = cljs.core.nth.call(null,vec__24340,(1),null);
...
var vec__24343 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24343,(0),null);
var end_column = cljs.core.nth.call(null,vec__24343,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__24346,(0),null);
var start_column = cljs.core.nth.call(null,vec__24346,(1),null);
...
var vec__24349 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24349,(0),null);
var end_column = cljs.core.nth.call(null,vec__24349,(1),null);
...
var vec__24352 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24352,(0),null);
var start_column = cljs.core.nth.call(null,vec__24352,(1),null);
...
var vec__24355 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24355,(0),null);
var end_column = cljs.core.nth.call(null,vec__24355,(1),null);
...
var sb = (function (){var G__24358 = (new goog.string.StringBuffer());
G__24358.append(initch);
...
var G__24360 = (function (){var G__24359 = sb;
G__24359.append(ch);

return G__24359;
})();
var G__24361 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24360;
ch = G__24361;
continue;
}
...
switch (G__24364) {
case "\\":
var G__24368 = (function (){var G__24365 = sb;
G__24365.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24365;
})();
var G__24369 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24368;
ch = G__24369;
continue;
...
break;
default:
var G__24370 = (function (){var G__24366 = sb;
G__24366.append(ch);

return G__24366;
})();
var G__24371 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24370;
ch = G__24371;
continue;
...
var line = cljs.core.nth.call(null,vec__24375,(0),null);
var column = cljs.core.nth.call(null,vec__24375,(1),null);
...
var vec__24380 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24380,(0),null);
var column = cljs.core.nth.call(null,vec__24380,(1),null);
...
var vec__24385 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24385,(0),null);
var column = cljs.core.nth.call(null,vec__24385,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24390 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24390,(0),null);
var start_column = cljs.core.nth.call(null,vec__24390,(1),null);
...
var vec__24393 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24393,(0),null);
var end_column = cljs.core.nth.call(null,vec__24393,(1),null);
...
var G__24396 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24396,true,null,opts,pending_forms);
...
var G__24397 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24397)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24397)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24397)){
...
var _STAR_suppress_read_STAR__orig_val__24398 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24399 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24399);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24398);
}});
...
var G__24400 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24400,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24400,rdr,first_line);
...
var G__24404 = matched;
var G__24405 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24404;
finished = G__24405;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24406 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24407 = (function (){var or__4160__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24407);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24406);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24408 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24409 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__24409);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24410 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24410,"(");
...
var G__24411 = (i + (1));
var G__24412 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4160__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__24408);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24413 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24413);
...
var G__24416 = cljs.core.next.call(null,s);
var G__24417 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24416;
key_vals = G__24417;
continue;
} else {
...
var gensym_env_orig_val__24422 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24423 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__24423);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__24422);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24424 = token;
var G__24424__$1 = (((G__24424 == null))?null:cljs.core.subs.call(null,G__24424,(1)));
var G__24424__$2 = (((G__24424__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24424__$1));
var G__24424__$3 = (((G__24424__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24424__$2));
var G__24424__$4 = (((G__24424__$3 == null))?null:cljs.core.symbol.call(null,G__24424__$3));
if((G__24424__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24424__$4);
}
})():(function (){var G__24425 = token;
var G__24425__$1 = (((G__24425 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24425));
if((G__24425__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24425__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e24432){if((e24432 instanceof Error)){
var e = e24432;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24436,reader){
var map__24437 = p__24436;
var map__24437__$1 = cljs.core.__destructure_map.call(null,map__24437);
var opts = map__24437__$1;
var eof = cljs.core.get.call(null,map__24437__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1718651152405
