...
return (new CustomEvent(event_name,(function (){var obj29280 = ({"detail":data});
return obj29280;
})()));
} else {
...
var f = (function (){var pred__29287 = cljs.core._EQ_;
var expr__29288 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29287.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29288))){
return (function (p1__29281_SHARP_){
return console.warn(p1__29281_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29287.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29288))){
return (function (p1__29282_SHARP_){
return console.debug(p1__29282_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29287.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29288))){
return (function (p1__29283_SHARP_){
return console.error(p1__29283_SHARP_);
});
} else {
return (function (p1__29284_SHARP_){
return console.log(p1__29284_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29291){
var map__29292 = p__29291;
var map__29292__$1 = cljs.core.__destructure_map.call(null,map__29292);
var opts = map__29292__$1;
var eval_fn = cljs.core.get.call(null,map__29292__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__29293_SHARP_){
return new_def.callback(p1__29293_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__29294){
var vec__29295 = p__29294;
var ky = cljs.core.nth.call(null,vec__29295,(0),null);
var v = cljs.core.nth.call(null,vec__29295,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1718650406188
