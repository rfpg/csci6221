...
return (new CustomEvent(event_name,(function (){var obj27320 = ({"detail":data});
return obj27320;
})()));
} else {
...
var f = (function (){var pred__27327 = cljs.core._EQ_;
var expr__27328 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27327.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27328))){
return (function (p1__27321_SHARP_){
return console.warn(p1__27321_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27327.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27328))){
return (function (p1__27322_SHARP_){
return console.debug(p1__27322_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27327.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27328))){
return (function (p1__27323_SHARP_){
return console.error(p1__27323_SHARP_);
});
} else {
return (function (p1__27324_SHARP_){
return console.log(p1__27324_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27331){
var map__27332 = p__27331;
var map__27332__$1 = cljs.core.__destructure_map.call(null,map__27332);
var opts = map__27332__$1;
var eval_fn = cljs.core.get.call(null,map__27332__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27333_SHARP_){
return new_def.callback(p1__27333_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27334){
var vec__27335 = p__27334;
var ky = cljs.core.nth.call(null,vec__27335,(0),null);
var v = cljs.core.nth.call(null,vec__27335,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1717626496199
