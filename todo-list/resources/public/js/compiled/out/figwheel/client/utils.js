...
return (new CustomEvent(event_name,(function (){var obj46888 = ({"detail":data});
return obj46888;
})()));
} else {
...
if(cljs.core.truth_(((figwheel.client.utils.html_env_QMARK_.call(null))?(function (){var and__4149__auto__ = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__46895 = cljs.core._EQ_;
var expr__46896 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46895.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46896))){
return (function (p1__46889_SHARP_){
return console.warn(p1__46889_SHARP_);
});
} else {
if(cljs.core.truth_(pred__46895.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46896))){
return (function (p1__46890_SHARP_){
return console.debug(p1__46890_SHARP_);
});
} else {
if(cljs.core.truth_(pred__46895.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46896))){
return (function (p1__46891_SHARP_){
return console.error(p1__46891_SHARP_);
});
} else {
return (function (p1__46892_SHARP_){
return console.log(p1__46892_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46899){
var map__46900 = p__46899;
var map__46900__$1 = cljs.core.__destructure_map.call(null,map__46900);
var opts = map__46900__$1;
var eval_fn = cljs.core.get.call(null,map__46900__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__46901_SHARP_){
return new_def.callback(p1__46901_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__46902){
var vec__46903 = p__46902;
var ky = cljs.core.nth.call(null,vec__46903,(0),null);
var v = cljs.core.nth.call(null,vec__46903,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1718651920623
