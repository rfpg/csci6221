...
return ajax.core.GET.call(null,"/tasks",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__39796_SHARP_){
return cljs.core.reset_BANG_.call(null,todo_list.core.tasks,cljs.reader.read_string.call(null,p1__39796_SHARP_));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__39797_SHARP_){
return console.error("Failed to fetch tasks",p1__39797_SHARP_);
})], null));
});
todo_list.core.add_task = (function todo_list$core$add_task(task){
return ajax.core.POST.call(null,"/tasks",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"params","params",710516235),task,new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__39798_SHARP_){
...
return console.log("Task added",p1__39798_SHARP_);
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__39799_SHARP_){
return console.error("Failed to add task",p1__39799_SHARP_);
})], null));
});
todo_list.core.remove_task = (function todo_list$core$remove_task(task_id){
var new_tasks = cljs.core.remove.call(null,(function (p1__39800_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__39800_SHARP_),task_id);
...
return console.log("Task removed",p1__39801_SHARP_);
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__39802_SHARP_){
return console.error("Failed to remove task",p1__39802_SHARP_);
})], null));
});
...
return console.log("Task updated",p1__39803_SHARP_);
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p1__39804_SHARP_){
return console.error("Failed to update task",p1__39804_SHARP_);
})], null));
});
...
return (function (){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.task-form","div.task-form",-1555877992),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Task Name",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,name),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39805_SHARP_){
return cljs.core.reset_BANG_.call(null,name,p1__39805_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"date",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,date),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39806_SHARP_){
return cljs.core.reset_BANG_.call(null,date,p1__39806_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Assignee",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,assignee),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39807_SHARP_){
return cljs.core.reset_BANG_.call(null,assignee,p1__39807_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,status),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39808_SHARP_){
return cljs.core.reset_BANG_.call(null,status,p1__39808_SHARP_.target.value);
...
var tasks_by_status = cljs.core.filter.call(null,(function (p1__39809_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(p1__39809_SHARP_),status);
}),cljs.core.deref.call(null,todo_list.core.tasks));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.tasks","div.tasks",-2091396832),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-drag-over","on-drag-over",-93410408),(function (p1__39810_SHARP_){
p1__39810_SHARP_.preventDefault();
...
})], null),(function (){var iter__4564__auto__ = (function todo_list$core$task_list_$_iter__39811(s__39812){
return (new cljs.core.LazySeq(null,(function (){
var s__39812__$1 = s__39812;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__39812__$1);
if(temp__5735__auto__){
var s__39812__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__39812__$2)){
var c__4562__auto__ = cljs.core.chunk_first.call(null,s__39812__$2);
var size__4563__auto__ = cljs.core.count.call(null,c__4562__auto__);
var b__39814 = cljs.core.chunk_buffer.call(null,size__4563__auto__);
if((function (){var i__39813 = (0);
while(true){
if((i__39813 < size__4563__auto__)){
var task = cljs.core._nth.call(null,c__4562__auto__,i__39813);
cljs.core.chunk_append.call(null,b__39814,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [todo_list.core.task_item,task], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null)));

var G__39815 = (i__39813 + (1));
i__39813 = G__39815;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__39814),todo_list$core$task_list_$_iter__39811.call(null,cljs.core.chunk_rest.call(null,s__39812__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__39814),null);
}
} else {
var task = cljs.core.first.call(null,s__39812__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [todo_list.core.task_item,task], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null)),todo_list$core$task_list_$_iter__39811.call(null,cljs.core.rest.call(null,s__39812__$2)));
}
} else {
return null;
}
...
})], null),"&times;"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),"Edit Task"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Task Name",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,name),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39816_SHARP_){
return cljs.core.reset_BANG_.call(null,name,p1__39816_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"date",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,date),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39817_SHARP_){
return cljs.core.reset_BANG_.call(null,date,p1__39817_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Assignee",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,assignee),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39818_SHARP_){
return cljs.core.reset_BANG_.call(null,assignee,p1__39818_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,status),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39819_SHARP_){
return cljs.core.reset_BANG_.call(null,status,p1__39819_SHARP_.target.value);
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"ready-to-start"], null),"Ready to start"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"in-progress"], null),"In Progress"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"waiting-for-review"], null),"Waiting for review"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"pending-deploy"], null),"Pending Deploy"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"done"], null),"Done"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"stuck"], null),"Stuck"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"blank"], null),"Blank"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
//# sourceMappingURL=core.js.map?rel=1718651917807
